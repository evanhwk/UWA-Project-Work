 ...
 * @version 2.0
 */
public class WhistNodeCheat implements WNode
{
    public WhistNodeCheat parent;
    public HashMap<Card, WhistNodeCheat> children;
     ...
     *
     * @param d WhistNodeCheat representing a random determinization of the game state.
     ...
     * </ul>
     */
    public WhistNodeCheat selectChild()
    {
        // for all n' of n
        for (WhistNodeCheat wN : children.values()) {
            //N'(n) <- N'(n') + 1
            wN.numSeen++;
        }
        double bestQ = -999999;
        ArrayList<WhistNodeCheat> wNlist = new ArrayList<>();
        double currQ;
     ...
     */
    public WhistNodeCheat addChild(Card play)
    {
        WhistNodeCheat child = new WhistNodeCheat(play, this);
     ...
     */
    public WhistNodeCheat getParent() 
    {
        return this.parent;
    }
}
